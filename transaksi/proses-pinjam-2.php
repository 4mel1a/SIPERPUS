...
$sql = "INSERT INTO peminjaman(id_anggota, tgl_pinjam, tgl_pinjam_tempo, id_petugas) VALUES('$id_anggota', '$tgl_pinjam', '$tgl_jatuh_tempo', '$id_petugas')";
	...
	if(cekPinjam($connect, $id_anggota) && $stok > 0){
		...
		// var_dump($res);
		$query = mysqli_query($connect, "SELECT id_pinjam FROM peminjaman WHERE tgl_pinjam='$tgl_pinjam' AND id_anggota='$id_anggota' AND tgl_pinjam_tempo='$tgl_jatuh_tempo' AND id_petugas='$id_petugas'");
