		...
		<div class="col-md-7">
			...
			<table class="table table-bordered">
				...
				<tr>
					...
					<td><?=date('d F Y', strtotime($detail['tgl_pinjam_tempo']))?></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="text-rigth" colspan="2">
						...
						<a class="btn btn-primary <?php if($detail['tgl_kembali']!=NULL){echo "enabled";}?>" href="form-kembali.php?id_pinjam=<?=$detail['id_pinjam']?>&id_buku=<?=$detail['id_buku']?>" role="button">Form Pengembalian</a>
					</td>
				</tr>
			</table>
		</div>
